...
public class PatientDetailsTm {
    ...
    public PatientDetailsTm() {
    }

    public PatientDetailsTm(String p_Id, String p_Name, String p_Nic, String p_Contact, String p_Address) {
        this.p_Id = p_Id;
        this.p_Name = p_Name;
        this.p_Nic = p_Nic;
